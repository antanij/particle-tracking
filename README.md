...
Works on *.bin files generated by Hamamatsu ORCA Flash cameras when acquiring fast movies and writing directly to the computer memory (using [CamLink frame grabber PCIe card](https://www.hamamatsu.com.cn/content/dam/hamamatsu-photonics/sites/static/sys/dcam-api-for-windows/compatibility-note/DCAM-API%20for%20Windows%20(24.6.6822)%20Compatibility%20Note.pdf)). See code for acquisition in the [flashenscope](https://github.com/antanij/flashenscope) repository.
